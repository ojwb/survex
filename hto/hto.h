...
extern	void	HTO_RegisterTagCallBack (HTO, const char *, CallBackPtr, CallBackPtr);
...
extern	void	HTO_NoCallBack (HTO, const char *);
extern	char	*HTO_GetObjectValue (HTO, const char *, char *);
extern	HTO	HTO_Create (char *);
extern	void	HTO_BeginObject (HTO, const char *);
extern	void	HTO_EndObject (HTO);
extern	void	HTO_WriteValue (HTO, const char *, const char *);
extern	void	HTO_PutChar (HTO, char);
extern	void	HTO_PutStr (HTO, const char *);
