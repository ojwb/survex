...
/* The DXF file produced is very basic, and a lot of programs fail to import
 * it successfully (though I think it is technically valid).
 * 
 * But this is useful as an example of how to use the img code from your own
 * programs */
